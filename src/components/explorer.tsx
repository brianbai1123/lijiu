  ...
  return (
    <>
      ...
      <section className="mx-auto w-full max-w-6xl px-5 pb-14">
        ...
        >
          <h2 className="font-serif text-2xl leading-tight font-semibold text-balance transition-colors group-hover:text-primary sm:text-4xl">
            {daily.title}
          </h2>
          <p className="mt-4 max-w-3xl text-[0.9375rem] leading-8 text-muted-foreground sm:text-base">
            {daily.essence}
          </p>
